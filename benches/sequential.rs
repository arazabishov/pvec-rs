...
fn push(_: &mut Criterion) {
    ...
    for p in params.iter() {
        ...
        bench_balanced!(p, RbVec, push, RBVEC_BALANCED);
...
//         bench_balanced!(RBVEC_BALANCED, p, RbVec, push, pop);
